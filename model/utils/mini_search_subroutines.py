...
def mini_search_eval(query,
    ...
    if display:
        ...
        tf.print(color_cyan + 'Scope:\t', line_int.format(*scopes), color_def)
        tf.print(color_cyan +'T1acc:\t' + color_def, line_float.format(*top1_acc))
        tf.print(color_cyan +'mRank:\t' + color_def, line_float.format(*mean_rank))
